...
themeRouter.get(endpoints_1.default.GET_ALL_THEMES, themeValidator_1.default.title(express_validator_1.query), themeValidator_1.default.cursor(express_validator_1.query), themeValidator_1.default.skip(express_validator_1.query), themeValidator_1.default.take(express_validator_1.query), themeController_1.default.getAllThemes);
