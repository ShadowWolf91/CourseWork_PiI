...
subjectRouter.get(endpoints_1.default.GET_ALL_SUBJECTS, subjectValidator_1.default.title(express_validator_1.query), subjectValidator_1.default.cursor(express_validator_1.query), subjectValidator_1.default.skip(express_validator_1.query), subjectValidator_1.default.take(express_validator_1.query), subjectController_1.default.getAllSubjects);
