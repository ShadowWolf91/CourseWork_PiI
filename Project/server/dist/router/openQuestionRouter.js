...
openQuestionRouter.get(endpoints_1.default.GET_ALL_OPEN_QUESTIONS, openQuestionValidator_1.default.title(express_validator_1.query), openQuestionValidator_1.default.cursor(express_validator_1.query), openQuestionValidator_1.default.skip(express_validator_1.query), openQuestionValidator_1.default.take(express_validator_1.query), openQuestionController_1.default.getAllOpenQuestions);
