...
statisticsRouter.get(endpoints_1.default.GET_ALL_STATISTICS, statisticsValidator_1.default.title(express_validator_1.query), statisticsValidator_1.default.cursor(express_validator_1.query), statisticsValidator_1.default.skip(express_validator_1.query), statisticsValidator_1.default.take(express_validator_1.query), statisticsController_1.default.getAllStatistics);
