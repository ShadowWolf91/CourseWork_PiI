...
TestRouter.get(endpoints_1.default.GET_ALL_TESTS, testValidator_1.default.title(express_validator_1.query), testValidator_1.default.cursor(express_validator_1.query), testValidator_1.default.skip(express_validator_1.query), testValidator_1.default.take(express_validator_1.query), testController_1.default.getAllTests);
