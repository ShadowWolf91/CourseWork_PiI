...
userRouter.get(endpoints_1.default.GET_ALL_USERS, userValidator_1.default.username(express_validator_1.query, true), userValidator_1.default.cursor(express_validator_1.query), userController_1.default.getAllUsers);
