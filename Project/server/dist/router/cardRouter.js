...
cardRouter.get(endpoints_1.default.GET_ALL_CARDS, cardValidator_1.default.cardName(express_validator_1.query), cardValidator_1.default.cursor(express_validator_1.query), cardController_1.default.getAllCards);
cardRouter.get(endpoints_1.default.GET_BY_THEME_ID, cardValidator_1.default.theme_id(express_validator_1.query), cardController_1.default.getCardByThemeId);
